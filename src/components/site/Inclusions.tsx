...
const ITEMS: Item[] = [
  {
    icon: BedDouble,
    title: "Accommodation",
    desc: "Hand-picked hotels & dharamshalas near Vrindavan, Mathura & Govardhan — clean, satvik and comfortable.",
    gradient: "linear-gradient(135deg, #FF6A00 0%, #FFB070 100%)",
    delay: "0s",
  },
  {
    icon: UtensilsCrossed,
    title: "All Meals",
    desc: "Pure satvik breakfast, lunch & dinner throughout your Braj Yatra — no compromise on food quality.",
    gradient: "linear-gradient(135deg, #E94E1B 0%, #FFC371 100%)",
    delay: "-0.6s",
  },
  {
    icon: Bus,
    title: "On-tour Transport",
    desc: "Private AC vehicles for Govardhan Parikrama, Braj Mandal darshan and all intercity transfers.",
  ...
  },
  {
    ...
    desc: "Local Braj experts available every day to guide you through temples, ghats and sacred sites.",
  ...
  },
  {
    ...
    desc: "Optimised Braj Yatra routes — covering Vrindavan, Mathura, Govardhan, Gokul, Barsana & Nandgaon efficiently.",
  ...
  },
  {
    icon: Clock4,
    title: "24/7 Support",
    desc: "Reach the Braj Miles team anytime before, during, or after your spiritual journey.",
    gradient: "linear-gradient(135deg, #0B0B0B 0%, #4A4A4A 100%)",
    delay: "-3s",
  },
];
          ...
          {ITEMS.map((it, i) => (
            <Reveal key={it.title} delay={i * 60}>
              <div className="group hover-lift flex items-center gap-5 rounded-2xl border border-border bg-card p-6 h-full">
                ...
                >
                  <div
                    className="icon-3d-inner"
                    style={{ background: it.gradient }}
                  >
                    <it.icon
                      className="icon-3d-icon h-7 w-7"
                      strokeWidth={2.2}
                      aria-hidden="true"
                    />
